...
## Supplements that may help
	...
	- Vitamin B5 100 -250 mg
	- Others: CBD, Holy Basil, L-Theanine, Magnesium, Lavendar oil, Lithium Orortate, Phosphatidylserine
## Big Pharma & Substances
	- Prazosin (mixed results)
	- Memantine (limited evidence)
	- Microdosing (if all else fails)

## Additional info
	- PTSD here is not a metabolic disorder, although there is huge association with the autonomic nervous system, which is very vulnerable to chronic inflammations
	- People get stuck in a psychologically weakened and overly defensive state, even after moving into a safer environment 
